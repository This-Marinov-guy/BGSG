...
const schema = yup.object().shape({
    ...
    q1: yup.string().required('Моля отговорете на въпроса').max(200, 'Лимит от 200 символа е надвишен'),
    q2: yup.string().required('Моля отговорете на въпроса').max(200, 'Лимит от 200 символа е надвишен'),
    q3: yup.string().required('Моля отговорете на въпроса').max(200, 'Лимит от 200 символа е надвишен'),
    q4: yup.string().required('Моля отговорете на въпроса').max(200, 'Лимит от 200 символа е надвишен'),
    ...
    return (
        <React.Fragment>
            ...
            <div className="container mt--80 mb--80">
                <p>Екипът на Българското Общество в Грьонинген се разраства, затова търсим нови попълнения в нашия отбор. Ако си ентусиазиран и постоянен, обичаш да организираш събития и споделяш мисията на Обществото, кандидатствай за свободните ни позиции като отговриш на въпросите (200 символа на въпрос) и, ако имаш желание, ни изпратиш CV (до 300 думи).</p>
                <br />
